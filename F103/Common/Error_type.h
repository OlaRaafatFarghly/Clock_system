...
#define PLL_MULTIPLICATION_FACTOR_ERR        16u

#define IRQn_SRC_ERR                         17u

#define PRI_GROUO_ERR                        18u


#define EXTI_INIT_STATE_ERR                  19u
#define EXTI_TRIG_STATE_ERR                  20u
#define EXTI_LINE_NUM_ERR                    21u
#define AFIO_EXTI_SRC_LINE_NUM_ERR           22u

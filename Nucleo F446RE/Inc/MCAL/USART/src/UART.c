...
uint32_t USART_init(UART_Handle_t*USART_Handle){
	uint32_t err=OK;
...
uint32_t USART_Send_Poll(UART_Handle_t*USART_Handle,uint32_t Data){
	uint32_t err=OK;
...
uint32_t USART_Rec_Poll(UART_Handle_t*USART_Handle,uint32_t* Dest){
	uint32_t err=OK;
	if(USART_Handle!=NULL){
...
uint32_t USART_Send_DMA(UART_Handle_t*COPY_Handle,uint32_t data){

...
uint32_t USART_init(UART_Handle_t*);

uint32_t USART_Send_Poll(UART_Handle_t*,uint32_t);
uint32_t USART_Rec_Poll(UART_Handle_t*,uint32_t*);

uint32_t USART_Send_DMA(UART_Handle_t*,uint32_t);

uint32_t USART_Send_IT(UART_Handle_t*,uint32_t);

uint32_t USART_Poll_For_Transfer(UART_Handle_t*,uint32_t);
